                ...
                <div className="relative h-80 sm:h-96 w-full bg-gradient-to-r from-primary to-primary/80">
                    <div className="absolute inset-0 flex items-center justify-center">
                        <div className="text-center px-4">
                            ...
                            <p className="text-xl text-white/90">Get in touch with {settings?.site_name || "African Editorial"}</p>
                        </div>
                    </div>
                </div>
                            ...
                            <div className="space-y-8">
                                <div className="flex gap-4">
                                    ...
                                    <div>
                                        ...
                                        <a href={`mailto:${settings?.contact_email || "info@africaneditorial.com"}`} className="text-primary hover:underline">
                                            {settings?.contact_email || "info@africaneditorial.com"}
                                        </a>
                                    </div>
                                </div>
                                ...
                                <div className="flex gap-4">
                                    ...
                                    <div>
                                        ...
                                        <a href={`tel:${settings?.contact_phone?.replace(/\D/g, '') || "+256414252600"}`} className="text-primary hover:underline">
                                            {settings?.contact_phone || "+256 (414) 252-600"}
                                        </a>
                                    </div>
                                </div>
                                ...
                                <div className="flex gap-4">
                                    ...
                                    <div>
                                        ...
                                        <p className="text-foreground/80 whitespace-pre-line">
                                            {settings?.contact_address || "Kampala, Uganda\nEast Africa"}
                                        </p>
                                    </div>
                                </div>
                            </div>

                            {settings?.department_emails && settings.department_emails.length > 0 && (
                                <div className="mt-12 pt-8 border-t border-border">
                                    <h3 className="font-bold text-foreground mb-4">Departments</h3>
                                    <div className="space-y-3 text-sm">
                                        {settings.department_emails.map((dept, i) => (
                                            <div key={i}>
                                                <p className="font-semibold text-foreground uppercase text-[10px] tracking-widest">{dept.name}</p>
                                                <a href={`mailto:${dept.email}`} className="text-primary hover:underline text-xs">
                                                    {dept.email}
                                                </a>
                                            </div>
                                        ))}
