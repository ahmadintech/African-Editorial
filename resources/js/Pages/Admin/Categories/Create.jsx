        ...
        <AdminLayout title="Create Category">
            <div className="max-w-2xl mx-auto">
                <div className="mb-8">
                    ...
                    <h2 className="text-3xl font-black text-foreground">Create New Category</h2>
                    <p className="text-muted-foreground mt-1">Add a new category to organize your posts.</p>
                </div>
